...
class BookBase(BaseModel):
    ...
    publication_year: Optional[int] = Field(None, ge=0, le=2100, description="Год публикации")
...
class BookUpdate(BaseModel):
    ...
    title: Optional[str] = Field(None, min_length=1, max_length=500, description="Название книги")
    author: Optional[str] = Field(None, min_length=1, max_length=200, description="Автор книги")
    isbn: Optional[str] = Field(None, max_length=20, description="ISBN книги")
    publication_year: Optional[int] = Field(None, ge=0, le=2100, description="Год публикации")
    genre: Optional[str] = Field(None, max_length=100, description="Жанр книги")
    description: Optional[str] = Field(None, description="Описание книги")
